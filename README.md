...
<!-- AUTO-GENERATED-CONTENT:START (CODE:src=./src/defaults/order.json) -->
<!-- The below code snippet is automatically added from ./src/defaults/order.json -->
...
<!-- AUTO-GENERATED-CONTENT:START (CODE:src=./src/defaults/transformations.ts) -->
<!-- The below code snippet is automatically added from ./src/defaults/transformations.ts -->
...
<!-- AUTO-GENERATED-CONTENT:START (CODE:src=./src/defaults/formatter.ts) -->
<!-- The below code snippet is automatically added from ./src/defaults/formatter.ts -->
...
| ---------- | --------- | ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| `config`   | `c`       | `FORMAT_PACKAGE_CONFIG`  | Path to a custom configuration to use. This configuration can be JavaScript, `JSON`, or any other format that your configuration of node can `require`. The default configuration can be found [here](src/defaults/index.ts). |                              |
...
1.  If the option `--config [path | module id]` or a `FORMAT_PACKAGE_CONFIG`
    ...
    return the [default](src/defaults/index.ts) configuration.
...
If no configuration is found, then the [default](src/defaults/index.ts) configuration is used.
...
| `clean-dependencies` | remove `node_modules` directory                                                                                             |
